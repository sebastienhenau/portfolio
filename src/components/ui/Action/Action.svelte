<script lang="ts">
    ...
    import type { TActionElement, TActionHref, TActionTarget, TActionType } from './Action.types';
    ...
    $: classList = clsx(
        {
            'before:content-empty before:absolute before:top-0 before:left-0 before:w-full before:h-full':
                !!actionWrapper,
        },
        $$props.class
    );

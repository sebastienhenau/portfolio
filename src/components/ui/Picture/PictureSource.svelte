...
>
    ...
    export type TPictureSourceMedia = TBreakpointIdentifier;

    export interface TPictureSourceProps {
        srcset: TPictureSourceSrcset;
        type: TPictureSourceType;
        media: TPictureSourceMedia;
    }
</script>

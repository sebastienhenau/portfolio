...
<Action
    {...action}
    class={clsx(
        "group relative z-0 inline-flex items-center motion-safe:transition-colors",
...
>
    {#if !buttonGroupContext && shade}
        <span
            class={clsx("pointer-events-none absolute inset-0 -z-20 rounded", {
                "bg-line": !inverse,
                "border border-line bg-accent-base": variant === "default" && inverse,
                "border border-line bg-site-base": variant === "neutral" && inverse,
    ...
    <span
        class={clsx(
            "pointer-events-none absolute inset-0 -z-10 rounded border border-line motion-safe:transition-transform",
            {
    ...
    {#if $$slots.left}
        <span
            class={clsx(
                "flex items-center self-stretch border-r border-line motion-safe:transition-transform",
    ...
    {#if $$slots.center && ($$slots.left || $$slots.right)}
        <span
            class={clsx(
                "flex flex-1 items-center justify-center motion-safe:transition-transform",
                childAnimationClass,
                {
                    "gap-3": size === "default" || size === "sm",
                    "gap-2": size === "xs",
    ...
    {#if $$slots.right}
        <span
            class={clsx(
                "flex items-center justify-center self-stretch border-l border-line motion-safe:transition-transform",
                childAnimationClass,
                {
                    "px-3": size === "sm" && form === "default",
                    "px-2": size === "xs" && form === "default",
